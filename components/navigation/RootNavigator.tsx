...
import LocationPositioningScreen from '@/src/screens/LocationPositioningScreen';
      ...
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        {!user ? (
          ...
          <>
            ...
            <Stack.Screen name="LocationPositioning" component={LocationPositioningScreen as any} />
